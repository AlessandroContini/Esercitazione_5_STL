...
struct PolygonalMesh
{
    ...
    std::vector<VectorXi> Cell2DsVertices = {}; ///< Cell2D Vertices indices, size 1 x NumberCell2DVertices[NumberCell2D]
	std::vector<unsigned int> Cell2DsNumEdges = {};
    std::vector<VectorXi> Cell2DsEdges = {}; ///< Cell2D Cell1D indices, size 1 x NumberCell2DEdges[NumberCell2D]
	std::map<unsigned int, list<unsigned int>> MarkerCell2Ds = {}; ///< Cell1D properties
};
